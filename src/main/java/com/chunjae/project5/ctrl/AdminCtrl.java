...
import com.chunjae.project5.biz.*;
import com.chunjae.project5.entity.*;
...
//        List<User> list = userService.userList(page);
    ...
    public String getReportList(HttpServletRequest request, Model model) {
        ...
        //List<Report> products = reportService.reportproductsList(page);
    ...
    public String reportMarDetail(@RequestParam("productsNo") int productsNo, Model model) throws Exception {

        //products products = productsService.productsDetail(productsNo);
//        model.addAttribute("products", products);

        List<Report> list = reportService.reasonMarList(productsNo);
        model.addAttribute("list", list);
    ...
    @ResponseBody
    public boolean readableUpdateMarPro(@RequestParam("readable") int readable, @RequestParam("productsNo") int productsNo){


        //productsService.readable(readable, productsNo);
